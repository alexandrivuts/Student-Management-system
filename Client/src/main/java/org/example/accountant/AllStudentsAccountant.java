...
public class AllStudentsAccountant extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(UserMenu.class.getResource("/accountant-view/all-studentsAccountant.fxml"));
    ...
    private void loadStudents() {
        try {
            ...
            if (response.getSuccess()) {
                ...
                studentsList.clear();  // Очистка старого списка
                studentsList.addAll(students);  // Заполнение нового списка
